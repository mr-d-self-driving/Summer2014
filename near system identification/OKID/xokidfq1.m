...
frf=frf+1*rand(size(frf));
%yb=armaxfd(frf,f,dt,r,pf,pb,[0 1 1])
%[A,B,C,D]=okid_fq(r,f,dt,frf,'batch',p);
%[A,B,C,D]=okid_fqw(r,f,dt,frf,'batch',p,10);
%[A,B,C,D]=okid_fq(r,f,dt,frf,'okid_fq',p);
[A,B,C,D]=okid_fqw(r,f,dt,frf,'okid_fqw',p,10);
