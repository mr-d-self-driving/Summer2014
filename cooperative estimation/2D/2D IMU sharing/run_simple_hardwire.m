...
for i = 1:length(tspan)
   ...
   for j = 1:2
       ...
       Hk(1,4:5) = [rjix/sqrt(rjix^2+rjiy^2) rjiy/sqrt(rjix^2+rjiy^2)];
       Hk(2,4:5) = [-rjiy/(rjiy^2+rjix^2) rjix/(rjiy^2+rjix^2)];
       ...
       Hk(3,4:5) = [rjix/sqrt(rjix^2+rjiy^2) rjiy/sqrt(rjix^2+rjiy^2)];
       Hk(4,[4:5 8]) = [-rjiy/(rjiy^2+rjix^2) rjix/(rjiy^2+rjix^2) -1];
       ...
       for kk = 1:8
           xn = x0hat;
           xn(kk) = xn(kk) + 1e-6;
           yt = [sqrt(xn(4)^2+xn(5)^2);atan2(xn(5),xn(4));sqrt(xn(4)^2+xn(5)^2);pi+atan2(xn(5),xn(4))-xn(8)];
           yt([2 4]) = minangle(yt([2 4]),yexp([2 4]));
           Hn(:,kk) = (yt-yexp)./1e-6;
       end
