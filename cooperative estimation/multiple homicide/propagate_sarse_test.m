...
Fk(5:7,3:7) = [[ -(x6^2*x9)/(x5^2 + x6^2), 0,                                                           (2*x3*x5*x6^2*x9)/(x5^2 + x6^2)^2, (uctrl*x5^4 + 2*uctrl*x5^2*x6^2 - 2*x3*x9*x5^2*x6 + uctrl*x6^4)/(x5^2 + x6^2)^2,   -(x3*x6^2)/(x5^2 + x6^2)]
    [ (x5*x6*x9)/(x5^2 + x6^2), 0, -(uctrl*x5^4 + 2*uctrl*x5^2*x6^2 + x3*x9*x5^2*x6 + uctrl*x6^4 - x3*x9*x6^3)/(x5^2 + x6^2)^2,                                     (x5*x9*(x3*x5^2 - x3*x6^2))/(x5^2 + x6^2)^2,   (x3*x5*x6)/(x5^2 + x6^2)]
    [  (x5*x9^2)/(x5^2 + x6^2), 0,                                                 -(x9^2*(x3*x5^2 - x3*x6^2))/(x5^2 + x6^2)^2,                                              -(2*x3*x5*x6*x9^2)/(x5^2 + x6^2)^2, (2*x3*x5*x9)/(x5^2 + x6^2)]];
