...
MAKEFILE = update_eq_17_state_mex.mk

include update_eq_17_state_mex.mki


SRC_FILES =  \
	update_eq_17_state_mexutil.c \
	update_eq_17_state_data.c \
...
MEX_FILE_NAME_WO_EXT = update_eq_17_state_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/update_eq_17_state"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/update_eq_17_state/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/update_eq_17_state/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/update_eq_17_state/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
