...
#ifndef __UKF_UPDATE_17_STATE_MEXUTIL_H__
#define __UKF_UPDATE_17_STATE_MEXUTIL_H__
/* Include files */
#include <math.h>
#include <stdlib.h>
#include <string.h>
...
#endif
/* End of code generation (ukf_update_17_state_mexutil.h) */
