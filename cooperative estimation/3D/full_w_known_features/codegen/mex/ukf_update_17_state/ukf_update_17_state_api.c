...
#include "ukf_update_17_state_api.h"
...
static void o_emlrt_marshallIn(const mxArray *src, const emlrtMsgIdentifier
  *msgId, real_T (**ret_data)[25], int32_T ret_size[1]);
static void p_emlrt_marshallIn(const mxArray *src, const emlrtMsgIdentifier
  *msgId, real_T (**ret_data)[625], int32_T ret_size[2]);
...
{
  const mxArray *y;
  static const int32_T iv75[1] = { 0 };

  const mxArray *m18;
  y = NULL;
  m18 = mxCreateNumericArray(1, (int32_T *)&iv75, mxDOUBLE_CLASS, mxREAL);
...
{
  const mxArray *y;
  static const int32_T iv76[2] = { 0, 0 };

  const mxArray *m19;
  y = NULL;
  m19 = mxCreateNumericArray(2, (int32_T *)&iv76, mxDOUBLE_CLASS, mxREAL);
  mxSetData((mxArray *)m19, (void *)u_data);
  mxSetDimensions((mxArray *)m19, u_size, 2);
  emlrtAssign(&y, m19);
  return y;
}
...
static void f_info_helper(ResolvedFunctionInfo info[556])
{
  ...
  info[322].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/ukf_update_17_state.m";
  info[322].name = "update_eq_17_state";
  ...
  info[322].fileTimeLo = 1416506755U;
  ...
  real_T (**y_data)[625], int32_T y_size[2])
{
  ...
  thisId.fIdentifier = identifier;
  thisId.fParent = NULL;
  h_emlrt_marshallIn(emlrtAlias(Pxk), &thisId, y_data, y_size);
...
static void g_info_helper(ResolvedFunctionInfo info[556])
{
  ...
  info[386].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/ukf_update_17_state.m";
  info[386].name = "measurement_eq_17_state";
...
static void h_info_helper(ResolvedFunctionInfo info[556])
{
  ...
  info[472].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[472].fileTimeLo = 1323195778U;
  ...
  info[501].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_minus.m";
  info[501].fileTimeLo = 1286843978U;
  ...
  emxArray_real_T *y)
{
  ...
  thisId.fIdentifier = identifier;
  thisId.fParent = NULL;
  j_emlrt_marshallIn(emlrtAlias(Pnk), &thisId, y);
  ...
  *msgId, real_T (**ret_data)[25], int32_T ret_size[1])
{
  ...
  emlrtCheckVsBuiltInR2012b(emlrtRootTLSGlobal, msgId, src, "double", FALSE, 1U,
    iv78, bv0, iv79);
  ret_size[0] = iv79[0];
  *ret_data = (real_T (*)[25])mxGetData(src);
  ...
  *msgId, real_T (**ret_data)[625], int32_T ret_size[2])
{
  ...
  ret_size[0] = iv81[0];
  ret_size[1] = iv81[1];
  *ret_data = (real_T (*)[625])mxGetData(src);
  emlrtDestroyArray(&src);
}
...
void ukf_update_17_state_api(const mxArray * const prhs[7], const mxArray *plhs
  [2])
{
  real_T (*xnew_data)[25];
  real_T (*Pnew_data)[625];
  emxArray_real_T *Pnk;
  int32_T xk_size[1];
  real_T (*xk_data)[25];
  int32_T Pxk_size[2];
  ...
  real_T (*ytilde_data)[250];
  real_T alpha;
  const mxArray *tmp;
  int32_T Pnew_size[2];
  int32_T xnew_size[1];
  xnew_data = (real_T (*)[25])mxMalloc(sizeof(real_T [25]));
  Pnew_data = (real_T (*)[625])mxMalloc(sizeof(real_T [625]));
  emlrtHeapReferenceStackEnterFcnR2012b(emlrtRootTLSGlobal);
  emxInit_real_T(&Pnk, 2, &sb_emlrtRTEI, TRUE);

  /* Marshall function inputs */
  e_emlrt_marshallIn(emlrtAlias(prhs[0]), "xk", &xk_data, xk_size);
  g_emlrt_marshallIn(emlrtAlias(prhs[1]), "Pxk", &Pxk_data, Pxk_size);
  g_emlrt_marshallIn(emlrtAlias(prhs[2]), "Pvk", &Pvk_data, Pvk_size);
  i_emlrt_marshallIn(emlrtAlias(prhs[3]), "Pnk", Pnk);
  k_emlrt_marshallIn(emlrtAlias(prhs[4]), "uk", &uk_data, uk_size);
  k_emlrt_marshallIn(emlrtAlias(prhs[5]), "ytilde", &ytilde_data, ytilde_size);
  ...
  ukf_update_17_state(*xk_data, xk_size, *Pxk_data, Pxk_size, *Pvk_data,
                      Pvk_size, Pnk, *uk_data, uk_size, *ytilde_data,
                      ytilde_size, alpha, *xnew_data, xnew_size, *Pnew_data,
                      Pnew_size);
  ...
  plhs[1] = d_emlrt_marshallOut(*Pnew_data, Pnew_size);
  Pnk->canFreeData = FALSE;
  emxFree_real_T(&Pnk);
  emlrtHeapReferenceStackLeaveFcnR2012b(emlrtRootTLSGlobal);
}

/* End of code generation (ukf_update_17_state_api.c) */
