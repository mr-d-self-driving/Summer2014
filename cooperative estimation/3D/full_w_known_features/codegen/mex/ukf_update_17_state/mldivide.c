...
static emlrtRSInfo qc_emlrtRSI = { 20, "eml_blas_xscal",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m"
};

static emlrtRSInfo sc_emlrtRSI = { 62, "eml_blas_xscal",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m"
};

static emlrtRSInfo tc_emlrtRSI = { 63, "eml_blas_xscal",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m"
};

static emlrtRSInfo uc_emlrtRSI = { 67, "eml_blas_xscal",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m"
};

static emlrtRSInfo vc_emlrtRSI = { 70, "eml_blas_xscal",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m"
};

static emlrtRSInfo wc_emlrtRSI = { 73, "eml_blas_xscal",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m"
};

static emlrtRSInfo le_emlrtRSI = { 103, "eml_matlab_zlarf",
...
static emlrtRTEInfo ac_emlrtRTEI = { 106, 5, "eml_qrsolve",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/eml/eml_qrsolve.m"
};

static emlrtRTEInfo bc_emlrtRTEI = { 99, 5, "eml_qrsolve",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/eml/eml_qrsolve.m"
};

static emlrtRTEInfo cc_emlrtRTEI = { 82, 21, "eml_qrsolve",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/eml/eml_qrsolve.m"
};

static emlrtRTEInfo dc_emlrtRTEI = { 76, 17, "eml_qrsolve",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/eml/eml_qrsolve.m"
};
...
{
  const mxArray *y;
  static const int32_T iv70[2] = { 1, 27 };
...
{
  const mxArray *y;
  static const int32_T iv72[2] = { 1, 32 };
  ...
  const mxArray *b_y;
  static const int32_T iv73[2] = { 1, 14 };

  char_T b_varargin_3[14];
  emlrtPushRtStackR2012b(&ch_emlrtRSI, emlrtRootTLSGlobal);
  emlrt_synchGlobalsToML();
  y = NULL;
  m15 = mxCreateCharArray(2, iv72);
  for (i = 0; i < 32; i++) {
    cv52[i] = cv53[i];
  }
  ...
  emxArray_real_T *Y)
{
  ...
  boolean_T exitg1;
  const mxArray *y;
  static const int32_T iv71[2] = { 1, 8 };
    ...
    if (tau->data[iy] != 0.0) {
      for (k = 0; k <= nb; k++) {
        ...
        if (temp2 != 0.0) {
          ...
          ix = A->size[0] + (int32_T)(1.0 - ((1.0 + (real_T)iy) + 1.0));
          emlrtForLoopVectorCheckR2012b((1.0 + (real_T)iy) + 1.0, 1.0, A->size[0],
            mxDOUBLE_CLASS, ix, &cc_emlrtRTEI, emlrtRootTLSGlobal);
          for (i = 0; i < ix; i++) {
            unnamed_idx_0 = ((uint32_T)iy + i) + 2U;
  ...
  for (k = 0; k <= nb; k++) {
    emlrtForLoopVectorCheckR2012b(1.0, 1.0, atmp, mxDOUBLE_CLASS, (int32_T)atmp,
      &bc_emlrtRTEI, emlrtRootTLSGlobal);
    ...
    emlrtForLoopVectorCheckR2012b(atmp, -1.0, 1.0, mxDOUBLE_CLASS, (int32_T)
      -(1.0 + (-1.0 - atmp)), &ac_emlrtRTEI, emlrtRootTLSGlobal);
