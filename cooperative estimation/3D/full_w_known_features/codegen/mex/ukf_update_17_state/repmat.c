...
static emlrtRSInfo li_emlrtRSI = { 11, "repmat",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/elmat/repmat.m"
};

static emlrtRSInfo mi_emlrtRSI = { 58, "repmat",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/elmat/repmat.m"
};

static emlrtRSInfo ni_emlrtRSI = { 60, "repmat",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/elmat/repmat.m"
};

static emlrtRSInfo oi_emlrtRSI = { 61, "repmat",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/elmat/repmat.m"
};
...
void repmat(const real_T a_data[601], const int32_T a_size[2], real_T m,
            emxArray_real_T *b)
{
  boolean_T p;
  const mxArray *y;
