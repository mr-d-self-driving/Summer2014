...
MAKEFILE = ukf_update_10_state_mex.mk

include ukf_update_10_state_mex.mki


SRC_FILES =  \
	ukf_update_10_state_mexutil.c \
	ukf_update_10_state_data.c \
	ukf_update_10_state_initialize.c \
	ukf_update_10_state_terminate.c \
	...
	ukf_update_10_state_emxutil.c \
	ukf_update_10_state_mex.c

MEX_FILE_NAME_WO_EXT = ukf_update_10_state_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/ukf_update_10_state"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/ukf_update_10_state/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/ukf_update_10_state/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/ukf_update_10_state/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
