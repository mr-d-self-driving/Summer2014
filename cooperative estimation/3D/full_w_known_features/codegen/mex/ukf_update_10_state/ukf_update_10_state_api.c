/*
 * ukf_update_10_state_api.c
 *
 * Code generation for function 'ukf_update_10_state_api'
 *
...
static emlrtRTEInfo yb_emlrtRTEI = { 1, 1, "ukf_update_10_state_api", "" };

/* Function Declarations */
static const mxArray *b_emlrt_marshallOut(ResolvedFunctionInfo u[622]);
static void b_info_helper(ResolvedFunctionInfo info[622]);
static const mxArray *c_emlrt_marshallOut(real_T u_data[100], int32_T u_size[1]);
static void c_info_helper(ResolvedFunctionInfo info[622]);
static const mxArray *d_emlrt_marshallOut(emxArray_real_T *u);
static void d_info_helper(ResolvedFunctionInfo info[622]);
static void e_emlrt_marshallIn(const mxArray *xk, const char_T *identifier,
  real_T (**y_data)[100], int32_T y_size[1]);
static void e_info_helper(ResolvedFunctionInfo info[622]);
static void f_emlrt_marshallIn(const mxArray *u, const emlrtMsgIdentifier
  *parentId, real_T (**y_data)[100], int32_T y_size[1]);
static void f_info_helper(ResolvedFunctionInfo info[622]);
static void g_emlrt_marshallIn(const mxArray *Pxk, const char_T *identifier,
  emxArray_real_T *y);
static void g_info_helper(ResolvedFunctionInfo info[622]);
static void h_emlrt_marshallIn(const mxArray *u, const emlrtMsgIdentifier
  *parentId, emxArray_real_T *y);
static void h_info_helper(ResolvedFunctionInfo info[622]);
static void i_emlrt_marshallIn(const mxArray *uk, const char_T *identifier,
  real_T (**y_data)[500], int32_T y_size[1]);
static void i_info_helper(ResolvedFunctionInfo info[622]);
static void info_helper(ResolvedFunctionInfo info[622]);
static void j_emlrt_marshallIn(const mxArray *u, const emlrtMsgIdentifier
  *parentId, real_T (**y_data)[500], int32_T y_size[1]);
static void j_info_helper(ResolvedFunctionInfo info[622]);
...
static void o_emlrt_marshallIn(const mxArray *src, const emlrtMsgIdentifier
  *msgId, real_T (**ret_data)[500], int32_T ret_size[1]);
...
static const mxArray *b_emlrt_marshallOut(ResolvedFunctionInfo u[622])
{
  ...
  y = NULL;
  iv45[0] = 622;
  emlrtAssign(&y, mxCreateStructArray(1, iv45, 0, NULL));
  for (i15 = 0; i15 < 622; i15++) {
    r22 = &u[i15];
    b_u = r22->context;
    b_y = NULL;
    m17 = mxCreateString(b_u);
    emlrtAssign(&b_y, m17);
    emlrtAddField(y, b_y, "context", i15);
    b_u = r22->name;
    c_y = NULL;
    m17 = mxCreateString(b_u);
    emlrtAssign(&c_y, m17);
    emlrtAddField(y, c_y, "name", i15);
    b_u = r22->dominantType;
    d_y = NULL;
    m17 = mxCreateString(b_u);
    emlrtAssign(&d_y, m17);
    emlrtAddField(y, d_y, "dominantType", i15);
    b_u = r22->resolved;
    e_y = NULL;
    m17 = mxCreateString(b_u);
    emlrtAssign(&e_y, m17);
    emlrtAddField(y, e_y, "resolved", i15);
    c_u = r22->fileTimeLo;
    f_y = NULL;
    m17 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m17) = c_u;
    emlrtAssign(&f_y, m17);
    emlrtAddField(y, f_y, "fileTimeLo", i15);
    c_u = r22->fileTimeHi;
    g_y = NULL;
    m17 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m17) = c_u;
    emlrtAssign(&g_y, m17);
    emlrtAddField(y, g_y, "fileTimeHi", i15);
    c_u = r22->mFileTimeLo;
    h_y = NULL;
    m17 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m17) = c_u;
    emlrtAssign(&h_y, m17);
    emlrtAddField(y, h_y, "mFileTimeLo", i15);
    c_u = r22->mFileTimeHi;
    i_y = NULL;
    m17 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m17) = c_u;
    emlrtAssign(&i_y, m17);
    emlrtAddField(y, i_y, "mFileTimeHi", i15);
  }
...
{
  const mxArray *y;
  static const int32_T iv46[1] = { 0 };

  const mxArray *m18;
  y = NULL;
  m18 = mxCreateNumericArray(1, (int32_T *)&iv46, mxDOUBLE_CLASS, mxREAL);
...
static const mxArray *d_emlrt_marshallOut(emxArray_real_T *u)
{
  ...
  const mxArray *m19;
  y = NULL;
  m19 = mxCreateNumericArray(2, (int32_T *)&iv47, mxDOUBLE_CLASS, mxREAL);
...
static void e_info_helper(ResolvedFunctionInfo info[622])
{
  ...
  info[314].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/ukf_update_10_state.m";
  info[314].name = "abs";
...
static void f_info_helper(ResolvedFunctionInfo info[622])
{
  ...
  info[322].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/ukf_update_10_state.m";
  info[322].name = "update_eq_10_state";
  info[322].dominantType = "double";
  info[322].resolved =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/update_eq_10_state.m";
  info[322].fileTimeLo = 1417646358U;
...
static void g_info_helper(ResolvedFunctionInfo info[622])
{
  ...
  info[386].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/ukf_update_10_state.m";
  info[386].name = "measurement_eq_10_state";
  info[386].dominantType = "double";
  info[386].resolved =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/measurement_eq_10_state.m";
  info[386].fileTimeLo = 1417648430U;
  ...
  info[406].name = "mrdivide";
  info[406].dominantType = "double";
  info[406].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  info[406].fileTimeLo = 1357976748U;
  info[406].fileTimeHi = 0U;
  info[406].mFileTimeLo = 1319755166U;
  info[406].mFileTimeHi = 0U;
  info[407].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_flint_colon";
  info[407].name = "floor";
  info[407].dominantType = "double";
  info[407].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  info[407].fileTimeLo = 1343855580U;
  ...
  info[411].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  info[411].fileTimeLo = 1348217130U;
  ...
  info[412].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  info[412].fileTimeLo = 1314761812U;
  info[412].fileTimeHi = 0U;
  info[412].mFileTimeLo = 0U;
  info[412].mFileTimeHi = 0U;
  info[413].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  info[413].name = "isequal";
  info[413].dominantType = "double";
  info[413].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  info[413].fileTimeLo = 1286843958U;
  info[413].fileTimeHi = 0U;
  info[413].mFileTimeLo = 0U;
  info[413].mFileTimeHi = 0U;
  info[414].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  info[414].name = "eml_const_nonsingleton_dim";
  info[414].dominantType = "double";
  info[414].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_const_nonsingleton_dim.m";
  info[414].fileTimeLo = 1286843896U;
  ...
  info[415].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[415].fileTimeLo = 1343855586U;
  ...
  info[416].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/atan2.m";
  info[416].fileTimeLo = 1343855572U;
  info[416].fileTimeHi = 0U;
  info[416].mFileTimeLo = 0U;
  info[416].mFileTimeHi = 0U;
  info[417].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/atan2.m";
  info[417].name = "eml_scalar_eg";
  info[417].dominantType = "double";
  info[417].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  info[417].fileTimeLo = 1286843996U;
  info[417].fileTimeHi = 0U;
  info[417].mFileTimeLo = 0U;
  info[417].mFileTimeHi = 0U;
  info[418].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/atan2.m";
  info[418].name = "eml_scalexp_alloc";
  info[418].dominantType = "double";
  info[418].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_alloc.m";
  info[418].fileTimeLo = 1352450060U;
  info[418].fileTimeHi = 0U;
  info[418].mFileTimeLo = 0U;
  info[418].mFileTimeHi = 0U;
  info[419].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/atan2.m";
  info[419].name = "eml_scalar_atan2";
  info[419].dominantType = "double";
  info[419].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_atan2.m";
  info[419].fileTimeLo = 1286843920U;
  info[419].fileTimeHi = 0U;
  info[419].mFileTimeLo = 0U;
  info[419].mFileTimeHi = 0U;
  info[420].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/vector2polar.m";
  info[420].name = "mpower";
  info[420].dominantType = "double";
  info[420].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  info[420].fileTimeLo = 1286844042U;
  info[420].fileTimeHi = 0U;
  info[420].mFileTimeLo = 0U;
  info[420].mFileTimeHi = 0U;
  info[421].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/measurement_eq_10_state.m";
  info[421].name = "minangle";
  info[421].dominantType = "double";
  info[421].resolved =
    "[E]/home/tim/github/Summer2014/cooperative estimation/2D/minangle.m";
  info[421].fileTimeLo = 1411329554U;
  info[421].fileTimeHi = 0U;
  info[421].mFileTimeLo = 0U;
  info[421].mFileTimeHi = 0U;
  info[422].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/2D/minangle.m";
  info[422].name = "mtimes";
  info[422].dominantType = "double";
  info[422].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  info[422].fileTimeLo = 1289544892U;
  ...
  info[423].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  info[423].fileTimeLo = 1343855566U;
  ...
  info[435].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  info[435].name = "eml_index_plus";
  info[435].dominantType = "coder.internal.indexInt";
  info[435].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  ...
  info[436].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  info[436].name = "eml_index_plus";
  info[436].dominantType = "double";
  info[436].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[436].fileTimeLo = 1286843978U;
  info[436].fileTimeHi = 0U;
  info[436].mFileTimeLo = 0U;
  info[436].mFileTimeHi = 0U;
  info[437].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  info[437].name = "eml_int_forloop_overflow_check";
  info[437].dominantType = "";
  info[437].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  info[437].fileTimeLo = 1346535540U;
  ...
  info[438].fileTimeLo = 1286843960U;
  ...
  info[439].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/2D/minangle.m";
  info[439].name = "find";
  info[439].dominantType = "logical";
  info[439].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/find.m";
  info[439].fileTimeLo = 1303171406U;
  ...
  info[440].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[440].fileTimeLo = 1323195778U;
  info[440].fileTimeHi = 0U;
  info[440].mFileTimeLo = 0U;
  info[440].mFileTimeHi = 0U;
  info[441].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/find.m!eml_find";
  info[441].name = "eml_scalar_eg";
  info[441].dominantType = "logical";
  info[441].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  info[441].fileTimeLo = 1286843996U;
  ...
  info[443].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[443].fileTimeLo = 1286843978U;
  ...
  info[444].resolved = "[IXMB]$matlabroot$/toolbox/matlab/lang/disp";
  info[444].fileTimeLo = MAX_uint32_T;
  info[444].fileTimeHi = MAX_uint32_T;
  info[444].mFileTimeLo = MAX_uint32_T;
  info[444].mFileTimeHi = MAX_uint32_T;
  info[445].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/ukf_update_10_state.m";
  info[445].name = "isnan";
  info[445].dominantType = "double";
  info[445].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  info[445].fileTimeLo = 1286843960U;
  ...
  info[446].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/any.m";
  info[446].fileTimeLo = 1286844034U;
  ...
  info[447].resolved = "[IXMB]$matlabroot$/toolbox/matlab/lang/disp";
  info[447].fileTimeLo = MAX_uint32_T;
  info[447].fileTimeHi = MAX_uint32_T;
  info[447].mFileTimeLo = MAX_uint32_T;
  info[447].mFileTimeHi = MAX_uint32_T;
}
...
static void h_info_helper(ResolvedFunctionInfo info[622])
{
  ...
  info[448].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/rank.m";
  info[448].fileTimeLo = 1286844030U;
  info[448].fileTimeHi = 0U;
  info[448].mFileTimeLo = 0U;
  info[448].mFileTimeHi = 0U;
  info[449].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/rank.m";
  info[449].name = "svd";
  info[449].dominantType = "double";
  info[449].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/svd.m";
  info[449].fileTimeLo = 1286844032U;
  info[449].fileTimeHi = 0U;
  info[449].mFileTimeLo = 0U;
  info[449].mFileTimeHi = 0U;
  info[450].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/svd.m";
  ...
  info[458].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  info[458].fileTimeLo = 1286843996U;
  ...
  info[459].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[459].fileTimeLo = 1286843978U;
  ...
  info[460].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m";
  info[460].name = "min";
  info[460].dominantType = "coder.internal.indexInt";
  info[460].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  ...
  info[461].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  ...
  info[462].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m";
  info[462].name = "eml_index_minus";
  info[462].dominantType = "double";
  info[462].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_minus.m";
  info[462].fileTimeLo = 1286843978U;
  ...
  info[463].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  ...
  info[481].dominantType = "coder.internal.indexInt";
  info[481].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  ...
  info[482].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xdot.m";
  info[482].name = "eml_scalar_eg";
  info[482].dominantType = "double";
  info[482].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  info[482].fileTimeLo = 1286843996U;
  ...
  info[486].name = "eml_index_class";
  info[486].dominantType = "";
  info[486].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[486].fileTimeLo = 1323195778U;
  ...
  info[490].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xaxpy.m";
  info[490].name = "eml_isa_uint";
  info[490].dominantType = "coder.internal.indexInt";
  info[490].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m";
  info[490].fileTimeLo = 1286843984U;
  ...
  info[491].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_minus.m";
  info[491].fileTimeLo = 1286843978U;
  ...
  info[494].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xaxpy.m";
  info[494].name = "eml_index_plus";
  info[494].dominantType = "coder.internal.indexInt";
  info[494].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[494].fileTimeLo = 1286843978U;
  ...
  info[495].fileTimeLo = 1343855566U;
  ...
  info[496].fileTimeLo = 1289544892U;
  info[496].fileTimeHi = 0U;
  info[496].mFileTimeLo = 0U;
  info[496].mFileTimeHi = 0U;
  info[497].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m";
  info[497].name = "realmin";
  info[497].dominantType = "char";
  info[497].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  info[497].fileTimeLo = 1307676442U;
  ...
  info[498].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m";
  info[498].name = "eps";
  info[498].dominantType = "char";
  info[498].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  info[498].fileTimeLo = 1326753196U;
  info[498].fileTimeHi = 0U;
  info[498].mFileTimeLo = 0U;
  info[498].mFileTimeHi = 0U;
  info[499].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m";
  info[499].name = "eml_error";
  info[499].dominantType = "char";
  info[499].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  info[499].fileTimeLo = 1343855558U;
  ...
  info[502].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_blas_inline.m";
  info[502].fileTimeLo = 1299101968U;
  ...
  info[505].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  info[505].fileTimeLo = 1357976748U;
  info[505].fileTimeHi = 0U;
  info[505].mFileTimeLo = 1319755166U;
  info[505].mFileTimeHi = 0U;
  info[506].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xrotg.m";
  info[506].name = "sqrt";
  info[506].dominantType = "double";
  info[506].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[506].fileTimeLo = 1343855586U;
  ...
  info[507].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  info[507].fileTimeLo = 1286843996U;
  info[507].fileTimeHi = 0U;
  info[507].mFileTimeLo = 0U;
  info[507].mFileTimeHi = 0U;
  info[508].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/rank.m";
  info[508].name = "length";
  info[508].dominantType = "double";
  info[508].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  info[508].fileTimeLo = 1303171406U;
  ...
  info[509].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[509].fileTimeLo = 1323195778U;
  info[509].fileTimeHi = 0U;
  info[509].mFileTimeLo = 0U;
  info[509].mFileTimeHi = 0U;
  info[510].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m!intlength";
  info[510].name = "coder.internal.indexIntRelop";
  info[510].dominantType = "";
  info[510].resolved =
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/indexIntRelop.m";
  info[510].fileTimeLo = 1326753522U;
  info[510].fileTimeHi = 0U;
  info[510].mFileTimeLo = 0U;
  info[510].mFileTimeHi = 0U;
  info[511].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/rank.m";
  info[511].name = "eps";
  info[511].dominantType = "double";
  info[511].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  info[511].fileTimeLo = 1326753196U;
  ...
  real_T (**y_data)[500], int32_T y_size[1])
{
  ...
  thisId.fIdentifier = identifier;
  thisId.fParent = NULL;
  j_emlrt_marshallIn(emlrtAlias(uk), &thisId, y_data, y_size);
  emlrtDestroyArray(&uk);
}

static void i_info_helper(ResolvedFunctionInfo info[622])
{
  info[512].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/rank.m";
  info[512].name = "mtimes";
  info[512].dominantType = "double";
  info[512].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  info[512].fileTimeLo = 1289544892U;
  ...
  info[513].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eye.m";
  info[513].fileTimeLo = 1286843888U;
  info[513].fileTimeHi = 0U;
  info[513].mFileTimeLo = 0U;
  info[513].mFileTimeHi = 0U;
  info[514].context =
    "[E]/home/tim/github/Summer2014/cooperative estimation/3D/full_w_known_features/ukf_update_10_state.m";
  info[514].name = "mldivide";
  info[514].dominantType = "double";
  info[514].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mldivide.p";
  info[514].fileTimeLo = 1357976748U;
  info[514].fileTimeHi = 0U;
  info[514].mFileTimeLo = 1319755166U;
  info[514].mFileTimeHi = 0U;
  info[515].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mldivide.p";
  info[515].name = "eml_scalar_eg";
  info[515].dominantType = "double";
  info[515].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  info[515].fileTimeLo = 1286843996U;
  info[515].fileTimeHi = 0U;
  info[515].mFileTimeLo = 0U;
  info[515].mFileTimeHi = 0U;
  info[516].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mldivide.p";
  info[516].name = "eml_lusolve";
  info[516].dominantType = "double";
  info[516].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_lusolve.m";
  info[516].fileTimeLo = 1309476396U;
  info[516].fileTimeHi = 0U;
  info[516].mFileTimeLo = 0U;
  info[516].mFileTimeHi = 0U;
  info[517].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_lusolve.m";
  info[517].name = "eml_index_class";
  info[517].dominantType = "";
  info[517].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[517].fileTimeLo = 1323195778U;
  ...
  info[523].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m";
  info[523].name = "eps";
  info[523].dominantType = "char";
  info[523].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  info[523].fileTimeLo = 1326753196U;
  ...
  info[533].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[533].fileTimeLo = 1323195778U;
  ...
  info[535].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!integer_colon_length_nonnegd";
  info[535].name = "intmax";
  info[535].dominantType = "char";
  info[535].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  info[535].fileTimeLo = 1311280516U;
  info[535].fileTimeHi = 0U;
  info[535].mFileTimeLo = 0U;
  info[535].mFileTimeHi = 0U;
  info[536].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!integer_colon_length_nonnegd";
  info[536].name = "eml_isa_uint";
  info[536].dominantType = "coder.internal.indexInt";
  info[536].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m";
  info[536].fileTimeLo = 1286843984U;
  ...
  info[538].name = "eml_int_forloop_overflow_check";
  info[538].dominantType = "";
  info[538].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  info[538].fileTimeLo = 1346535540U;
  info[538].fileTimeHi = 0U;
  info[538].mFileTimeLo = 0U;
  info[538].mFileTimeHi = 0U;
  info[539].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m";
  info[539].name = "eml_index_class";
  info[539].dominantType = "";
  info[539].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[539].fileTimeLo = 1323195778U;
  info[539].fileTimeHi = 0U;
  info[539].mFileTimeLo = 0U;
  info[539].mFileTimeHi = 0U;
  info[540].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m";
  info[540].name = "eml_index_plus";
  info[540].dominantType = "double";
  info[540].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[540].fileTimeLo = 1286843978U;
  info[540].fileTimeHi = 0U;
  info[540].mFileTimeLo = 0U;
  info[540].mFileTimeHi = 0U;
  info[541].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m";
  info[541].name = "eml_int_forloop_overflow_check";
  info[541].dominantType = "";
  info[541].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  info[541].fileTimeLo = 1346535540U;
  info[541].fileTimeHi = 0U;
  info[541].mFileTimeLo = 0U;
  info[541].mFileTimeHi = 0U;
  info[542].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m";
  info[542].name = "eml_index_minus";
  ...
  info[543].dominantType = "coder.internal.indexInt";
  info[543].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_minus.m";
  ...
  info[550].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[550].fileTimeLo = 1323195778U;
  ...
  info[552].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  info[552].fileTimeLo = 1343855566U;
  info[552].fileTimeHi = 0U;
  info[552].mFileTimeLo = 0U;
  info[552].mFileTimeHi = 0U;
  info[553].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_ixamax.m";
  info[553].name = "eml_int_forloop_overflow_check";
  info[553].dominantType = "";
  info[553].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  info[553].fileTimeLo = 1346535540U;
  info[553].fileTimeHi = 0U;
  info[553].mFileTimeLo = 0U;
  info[553].mFileTimeHi = 0U;
  info[554].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_ixamax.m";
  info[554].name = "eml_index_plus";
  info[554].dominantType = "coder.internal.indexInt";
  info[554].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[554].fileTimeLo = 1286843978U;
  info[554].fileTimeHi = 0U;
  info[554].mFileTimeLo = 0U;
  info[554].mFileTimeHi = 0U;
  info[555].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m";
  info[555].name = "eml_xswap";
  info[555].dominantType = "double";
  info[555].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xswap.m";
  info[555].fileTimeLo = 1299101978U;
  info[555].fileTimeHi = 0U;
  info[555].mFileTimeLo = 0U;
  info[555].mFileTimeHi = 0U;
  info[556].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xswap.m";
  info[556].name = "eml_blas_inline";
  info[556].dominantType = "";
  info[556].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_blas_inline.m";
  info[556].fileTimeLo = 1299101968U;
  info[556].fileTimeHi = 0U;
  info[556].mFileTimeLo = 0U;
  info[556].mFileTimeHi = 0U;
  info[557].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xswap.m";
  info[557].name = "eml_index_class";
  info[557].dominantType = "";
  info[557].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[557].fileTimeLo = 1323195778U;
  info[557].fileTimeHi = 0U;
  info[557].mFileTimeLo = 0U;
  info[557].mFileTimeHi = 0U;
  info[558].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xswap.m";
  info[558].name = "eml_refblas_xswap";
  info[558].dominantType = "double";
  info[558].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xswap.m";
  info[558].fileTimeLo = 1299101986U;
  info[558].fileTimeHi = 0U;
  info[558].mFileTimeLo = 0U;
  info[558].mFileTimeHi = 0U;
  info[559].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xswap.m";
  info[559].name = "eml_index_class";
  info[559].dominantType = "";
  info[559].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[559].fileTimeLo = 1323195778U;
  ...
  info[560].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xswap.m";
  info[560].name = "abs";
  info[560].dominantType = "coder.internal.indexInt";
  info[560].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  info[560].fileTimeLo = 1343855566U;
  info[560].fileTimeHi = 0U;
  info[560].mFileTimeLo = 0U;
  info[560].mFileTimeHi = 0U;
  info[561].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xswap.m";
  info[561].name = "eml_int_forloop_overflow_check";
  info[561].dominantType = "";
  info[561].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  info[561].fileTimeLo = 1346535540U;
  info[561].fileTimeHi = 0U;
  info[561].mFileTimeLo = 0U;
  info[561].mFileTimeHi = 0U;
  info[562].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xswap.m";
  info[562].name = "eml_index_minus";
  info[562].dominantType = "coder.internal.indexInt";
  info[562].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_minus.m";
  info[562].fileTimeLo = 1286843978U;
  info[562].fileTimeHi = 0U;
  info[562].mFileTimeLo = 0U;
  info[562].mFileTimeHi = 0U;
  info[563].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xswap.m";
  info[563].name = "eml_index_plus";
  info[563].dominantType = "coder.internal.indexInt";
  info[563].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[563].fileTimeLo = 1286843978U;
...
static void info_helper(ResolvedFunctionInfo info[622])
{
  ...
  info[1].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  info[1].fileTimeLo = 1286844042U;
  info[1].fileTimeHi = 0U;
  info[1].mFileTimeLo = 0U;
  info[1].mFileTimeHi = 0U;
  info[2].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  info[2].name = "power";
  info[2].dominantType = "double";
  info[2].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  info[2].fileTimeLo = 1348217130U;
...
static void j_info_helper(ResolvedFunctionInfo info[622])
{
  ...
  info[579].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[579].fileTimeLo = 1323195778U;
  info[579].fileTimeHi = 0U;
  info[579].mFileTimeLo = 0U;
  info[579].mFileTimeHi = 0U;
  info[580].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xtrsm.m";
  info[580].name = "eml_int_forloop_overflow_check";
  info[580].dominantType = "";
  info[580].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  info[580].fileTimeLo = 1346535540U;
  info[580].fileTimeHi = 0U;
  info[580].mFileTimeLo = 0U;
  info[580].mFileTimeHi = 0U;
  info[581].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xtrsm.m";
  info[581].name = "eml_index_times";
  info[581].dominantType = "coder.internal.indexInt";
  info[581].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_times.m";
  info[581].fileTimeLo = 1286843980U;
  info[581].fileTimeHi = 0U;
  info[581].mFileTimeLo = 0U;
  info[581].mFileTimeHi = 0U;
  info[582].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xtrsm.m";
  info[582].name = "eml_index_plus";
  info[582].dominantType = "coder.internal.indexInt";
  info[582].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[582].fileTimeLo = 1286843978U;
  ...
  info[583].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[583].fileTimeLo = 1286843978U;
  info[583].fileTimeHi = 0U;
  info[583].mFileTimeLo = 0U;
  info[583].mFileTimeHi = 0U;
  info[584].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xtrsm.m";
  info[584].name = "eml_div";
  info[584].dominantType = "double";
  info[584].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  info[584].fileTimeLo = 1313373010U;
  info[584].fileTimeHi = 0U;
  info[584].mFileTimeLo = 0U;
  info[584].mFileTimeHi = 0U;
  info[585].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mldivide.p";
  info[585].name = "eml_qrsolve";
  info[585].dominantType = "double";
  info[585].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_qrsolve.m";
  info[585].fileTimeLo = 1307676444U;
  ...
  info[591].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[591].name = "min";
  info[591].dominantType = "coder.internal.indexInt";
  info[591].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  info[591].fileTimeLo = 1311280518U;
  info[591].fileTimeHi = 0U;
  info[591].mFileTimeLo = 0U;
  info[591].mFileTimeHi = 0U;
  info[592].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[592].name = "eml_scalar_eg";
  info[592].dominantType = "double";
  info[592].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  info[592].fileTimeLo = 1286843996U;
  ...
  info[593].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[593].name = "colon";
  info[593].dominantType = "coder.internal.indexInt";
  info[593].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  info[593].fileTimeLo = 1348217128U;
  ...
  info[594].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[594].name = "eps";
  info[594].dominantType = "char";
  info[594].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  info[594].fileTimeLo = 1326753196U;
  ...
  info[595].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[595].fileTimeLo = 1343855586U;
  info[595].fileTimeHi = 0U;
  info[595].mFileTimeLo = 0U;
  info[595].mFileTimeHi = 0U;
  info[596].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[596].name = "eml_int_forloop_overflow_check";
  info[596].dominantType = "";
  info[596].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  info[596].fileTimeLo = 1346535540U;
  info[596].fileTimeHi = 0U;
  info[596].mFileTimeLo = 0U;
  info[596].mFileTimeHi = 0U;
  info[597].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[597].name = "eml_xnrm2";
  info[597].dominantType = "double";
  info[597].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xnrm2.m";
  info[597].fileTimeLo = 1299101976U;
  info[597].fileTimeHi = 0U;
  info[597].mFileTimeLo = 0U;
  info[597].mFileTimeHi = 0U;
  info[598].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[598].name = "eml_index_plus";
  info[598].dominantType = "coder.internal.indexInt";
  info[598].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[598].fileTimeLo = 1286843978U;
  info[598].fileTimeHi = 0U;
  info[598].mFileTimeLo = 0U;
  info[598].mFileTimeHi = 0U;
  info[599].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[599].name = "eml_index_minus";
  info[599].dominantType = "double";
  info[599].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_minus.m";
  info[599].fileTimeLo = 1286843978U;
  info[599].fileTimeHi = 0U;
  info[599].mFileTimeLo = 0U;
  info[599].mFileTimeHi = 0U;
  info[600].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[600].name = "eml_index_plus";
  info[600].dominantType = "double";
  info[600].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[600].fileTimeLo = 1286843978U;
  info[600].fileTimeHi = 0U;
  info[600].mFileTimeLo = 0U;
  info[600].mFileTimeHi = 0U;
  info[601].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[601].name = "eml_index_times";
  info[601].dominantType = "coder.internal.indexInt";
  info[601].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_times.m";
  info[601].fileTimeLo = 1286843980U;
  info[601].fileTimeHi = 0U;
  info[601].mFileTimeLo = 0U;
  info[601].mFileTimeHi = 0U;
  info[602].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[602].name = "eml_index_minus";
  info[602].dominantType = "coder.internal.indexInt";
  info[602].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_minus.m";
  info[602].fileTimeLo = 1286843978U;
  info[602].fileTimeHi = 0U;
  info[602].mFileTimeLo = 0U;
  info[602].mFileTimeHi = 0U;
  info[603].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[603].name = "eml_ixamax";
  info[603].dominantType = "double";
  info[603].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_ixamax.m";
  info[603].fileTimeLo = 1299101970U;
  info[603].fileTimeHi = 0U;
  info[603].mFileTimeLo = 0U;
  info[603].mFileTimeHi = 0U;
  info[604].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[604].name = "eml_xswap";
  info[604].dominantType = "double";
  info[604].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xswap.m";
  info[604].fileTimeLo = 1299101978U;
  info[604].fileTimeHi = 0U;
  info[604].mFileTimeLo = 0U;
  info[604].mFileTimeHi = 0U;
  info[605].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[605].name = "eml_matlab_zlarfg";
  info[605].dominantType = "double";
  info[605].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zlarfg.m";
  info[605].fileTimeLo = 1286844022U;
  info[605].fileTimeHi = 0U;
  info[605].mFileTimeLo = 0U;
  info[605].mFileTimeHi = 0U;
  info[606].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[606].name = "eml_matlab_zlarf";
  info[606].dominantType = "char";
  info[606].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zlarf.m";
  info[606].fileTimeLo = 1286844022U;
  info[606].fileTimeHi = 0U;
  info[606].mFileTimeLo = 0U;
  info[606].mFileTimeHi = 0U;
  info[607].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zlarf.m";
  info[607].name = "coder.internal.indexIntRelop";
  info[607].dominantType = "";
  info[607].resolved =
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/indexIntRelop.m";
  info[607].fileTimeLo = 1326753522U;
  info[607].fileTimeHi = 0U;
  info[607].mFileTimeLo = 0U;
  info[607].mFileTimeHi = 0U;
  info[608].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zlarf.m";
  info[608].name = "eml_index_times";
  info[608].dominantType = "double";
  info[608].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_times.m";
  info[608].fileTimeLo = 1286843980U;
  ...
  info[609].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  info[609].fileTimeLo = 1343855566U;
  info[609].fileTimeHi = 0U;
  info[609].mFileTimeLo = 0U;
  info[609].mFileTimeHi = 0U;
  info[610].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgeqp3.m";
  info[610].name = "mtimes";
  info[610].dominantType = "double";
  info[610].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  info[610].fileTimeLo = 1289544892U;
  ...
  info[611].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  info[611].fileTimeLo = 1311280516U;
  info[611].fileTimeHi = 0U;
  info[611].mFileTimeLo = 0U;
  info[611].mFileTimeHi = 0U;
  info[612].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_qrsolve.m";
  info[612].name = "eml_xcabs1";
  info[612].dominantType = "double";
  info[612].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xcabs1.m";
  info[612].fileTimeLo = 1286843906U;
  info[612].fileTimeHi = 0U;
  info[612].mFileTimeLo = 0U;
  info[612].mFileTimeHi = 0U;
  info[613].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_qrsolve.m";
  info[613].name = "mtimes";
  info[613].dominantType = "double";
  info[613].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  info[613].fileTimeLo = 1289544892U;
  ...
  info[614].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  info[614].fileTimeLo = 1326753196U;
  info[614].fileTimeHi = 0U;
  info[614].mFileTimeLo = 0U;
  info[614].mFileTimeHi = 0U;
  info[615].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_qrsolve.m";
  info[615].name = "eml_flt2str";
  info[615].dominantType = "double";
  info[615].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_flt2str.m";
  info[615].fileTimeLo = 1309476396U;
  ...
  *msgId, real_T (**ret_data)[500], int32_T ret_size[1])
{
  ...
  emlrtCheckVsBuiltInR2012b(emlrtRootTLSGlobal, msgId, src, "double", FALSE, 1U,
    iv53, bv2, iv54);
  ret_size[0] = iv54[0];
  *ret_data = (real_T (*)[500])mxGetData(src);
  emlrtDestroyArray(&src);
}
...
void ukf_update_10_state_api(const mxArray * const prhs[7], const mxArray *plhs
  [2])
{
  ...
  real_T (*ytilde_data)[500];
  real_T alpha;
  const mxArray *tmp;
  emxArray_real_T *Pnew;
  int32_T xnew_size[1];
  xnew_data = (real_T (*)[100])mxMalloc(sizeof(real_T [100]));
  emlrtHeapReferenceStackEnterFcnR2012b(emlrtRootTLSGlobal);
  emxInit_real_T(&Pxk, 2, &yb_emlrtRTEI, TRUE);
  emxInit_real_T(&Pvk, 2, &yb_emlrtRTEI, TRUE);
  emxInit_real_T(&Pnk, 2, &yb_emlrtRTEI, TRUE);

  /* Marshall function inputs */
  e_emlrt_marshallIn(emlrtAlias(prhs[0]), "xk", &xk_data, xk_size);
  g_emlrt_marshallIn(emlrtAlias(prhs[1]), "Pxk", Pxk);
  g_emlrt_marshallIn(emlrtAlias(prhs[2]), "Pvk", Pvk);
  g_emlrt_marshallIn(emlrtAlias(prhs[3]), "Pnk", Pnk);
  i_emlrt_marshallIn(emlrtAlias(prhs[4]), "uk", &uk_data, uk_size);
  i_emlrt_marshallIn(emlrtAlias(prhs[5]), "ytilde", &ytilde_data, ytilde_size);
  ...
  emxInit_real_T(&Pnew, 2, &yb_emlrtRTEI, TRUE);

  /* Invoke the target function */
  ukf_update_10_state(*xk_data, xk_size, Pxk, Pvk, Pnk, *uk_data, uk_size,
                      *ytilde_data, ytilde_size, alpha, *xnew_data, xnew_size,
                      Pnew);
...
/* End of code generation (ukf_update_10_state_api.c) */
