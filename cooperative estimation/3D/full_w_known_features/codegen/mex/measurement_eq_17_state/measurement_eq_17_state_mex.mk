...
MAKEFILE = measurement_eq_17_state_mex.mk

include measurement_eq_17_state_mex.mki


SRC_FILES =  \
	measurement_eq_17_state_mexutil.c \
	measurement_eq_17_state_data.c \
	...
	measurement_eq_17_state_emxutil.c \
	measurement_eq_17_state_mex.c

MEX_FILE_NAME_WO_EXT = measurement_eq_17_state_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/measurement_eq_17_state"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/measurement_eq_17_state/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/measurement_eq_17_state/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/measurement_eq_17_state/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
