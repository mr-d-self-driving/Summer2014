...
static emlrtRSInfo fb_emlrtRSI = { 11, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo gb_emlrtRSI = { 13, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo hb_emlrtRSI = { 16, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo ib_emlrtRSI = { 18, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo jb_emlrtRSI = { 23, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo kb_emlrtRSI = { 33, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo lb_emlrtRSI = { 40, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo mb_emlrtRSI = { 57, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo nb_emlrtRSI = { 84, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo ob_emlrtRSI = { 85, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo fh_emlrtRSI = { 160, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};

static emlrtRSInfo gh_emlrtRSI = { 161, "sqrtm",
  "/usr/local/MATLAB/MATLAB_Production_Server/R2013a/toolbox/eml/lib/matlab/matfun/sqrtm.m"
};
...
void sqrtm(const emxArray_real_T *A, emxArray_creal_T *X, real_T *arg2)
{
  ...
  emxInit_creal_T(&r21, 2, &k_emlrtRTEI, TRUE);
  ...
  if ((Q->size[1] == 1) || (R->size[0] == 1)) {
    ...
    iv35[0] = (int16_T)Q->size[0];
    iv35[1] = (int16_T)R->size[1];
  ...
  if ((y->size[1] == 1) || (T->size[0] == 1)) {
    ...
    iv35[0] = (int16_T)y->size[0];
    iv35[1] = (int16_T)T->size[1];
    emlrtPushRtStackR2012b(&hh_emlrtRSI, emlrtRootTLSGlobal);
    i = X->size[0] * X->size[1];
    X->size[0] = iv35[0];
    emxEnsureCapacity((emxArray__common *)X, i, (int32_T)sizeof(creal_T),
  ...
  if ((X->size[1] == 1) || (X->size[0] == 1)) {
    ...
    iv35[0] = (int16_T)X->size[0];
    iv35[1] = (int16_T)X->size[1];
    emlrtPushRtStackR2012b(&hh_emlrtRSI, emlrtRootTLSGlobal);
    i = T->size[0] * T->size[1];
    T->size[0] = iv35[0];
    emxEnsureCapacity((emxArray__common *)T, i, (int32_T)sizeof(creal_T),
