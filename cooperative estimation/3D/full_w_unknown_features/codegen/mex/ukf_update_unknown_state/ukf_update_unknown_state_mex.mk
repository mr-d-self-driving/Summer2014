START_DIR = /home/tim/github/Summer2014/cooperative\ estimation/3D/full_w_unknown_features

MATLAB_ROOT = /usr/local/MATLAB/MATLAB_Production_Server/R2013a
MAKEFILE = ukf_update_unknown_state_mex.mk

include ukf_update_unknown_state_mex.mki


SRC_FILES =  \
	ukf_update_unknown_state_mexutil.c \
	ukf_update_unknown_state_data.c \
	ukf_update_unknown_state_initialize.c \
	...
	ukf_update_unknown_state_emxutil.c \
	ukf_update_unknown_state_mex.c

MEX_FILE_NAME_WO_EXT = ukf_update_unknown_state_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/ukf_update_unknown_state"
SYS_INCLUDE += -I "/home/tim/github/Summer2014/cooperative"
SYS_INCLUDE += -I "$(START_DIR)/estimation/3D/full_w_unknown_features"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/ukf_update_unknown_state/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/ukf_update_unknown_state/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/ukf_update_unknown_state/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
