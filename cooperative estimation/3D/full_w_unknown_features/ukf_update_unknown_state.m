function [xnew,Pnew] = ukf_update_unknown_state(xk,Pxk,Pvk,Pnk,uk,ytilde,alpha)
...
XAUGPLUS = update_eq_unknown_state(XAUG(1:n,:),XAUG(n+(1:vl),:),uk);
...
YKAUG = measurement_eq_unknown_state(XAUGPLUS(1:n,:),XAUG(n+vl+(1:nl),:),uk);
