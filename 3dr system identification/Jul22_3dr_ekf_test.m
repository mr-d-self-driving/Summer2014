...
folder = 'C:\Users\fatadama\Documents\summer 2014\Optitrack\July 22 3dr ekf test';
%%
...
delta = alignTimeHistoriesPh(t,-xyz(:,3),tv,flow(:,5));
%delta = alignTimeHistoriesPh(t(in1:end),-xyz(in1:end,3),tv(in2:end),flow(in2:end,5));
