...
folder = 'C:\Users\fatadama\Documents\summer 2014\Optitrack\August 5 heavy ardrone test';
...
n3b_in = [-sin(euler_in(:,2)) sin(euler_in(:,1)).*cos(euler_in(:,2)) cos(euler_in(:,1)).*cos(euler_in(:,2))];
tind2 = [];
for i = 1:size(tuse,1)
