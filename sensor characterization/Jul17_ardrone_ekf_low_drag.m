...
folder = 'C:\Users\fatadama\Documents\summer 2014\Optitrack\July 17 ardrone mass coef low';
%%
...
delta = alignTimeHistories(t,euler(:,1),tv,ekf(:,4),-1.5);
...
plot(t,wb(:,3));
hold on;
plot(tv,Gyro(:,3),'m-','linewidth',2);
plot(tv,ekf(:,6),'r--','linewidth',2);
plot(tv,Att(:,6),'k--');
legend('truth','raw gyro','byu ekf','px4 ekf');
ylabel('r (rad/s)');
set(gcf,'position',[150 250 1150 225]);
%errors
figure;
