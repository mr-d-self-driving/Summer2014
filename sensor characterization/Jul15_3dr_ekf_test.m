...
folder = 'C:\Users\fatadama\Documents\summer 2014\Optitrack\July 15 3dr ekf test';
%%
fname1 = [folder '\log.csv'];
fname2 = [folder '\opti.csv'];

[dat2,txt] = xlsread(fname2);
[t,xyz,quat] = ros2body_vrpn(dat2,txt);
...
delta = alignTimeHistories(t,-xyz(:,3),tv,flow(:,5),0);
