...
folder = 'C:\Users\fatadama\Documents\summer 2014\Optitrack\July 8 estimator test 2';
...
delta = alignTimeHistories(t,euler(:,2),tv,ekf(:,5),-1.02); %for test 2
%delta = alignTimeHistories(t,euler(:,2),tv,ekf(:,5),4.46); %for test 1
